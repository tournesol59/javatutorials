...
//   }
   ...
   public BufferedReader readDataSupplier() {
      try {
     	   return new BufferedReader( InputStreamReader(new FileReader("C:\\Users\\Frédéric\\Documents\\eclipse\\eclipse-newimport\\CustomerJDBCTasks\\src\\main\\resources\\customerdbtest.properties")));
      } catch (IOException e) {
